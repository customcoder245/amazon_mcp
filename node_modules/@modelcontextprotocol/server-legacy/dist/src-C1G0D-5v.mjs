...
function stampServerInfoMeta(result, serverInfo) {
	...
	if (!isPlainObject$3(meta)) return result;
...
//#endregion
export { OAuthTokensSchema as a, OAuthTokenRevocationRequestSchema as i, OAuthClientInformationFullSchema as n, OAuthClientMetadataSchema as r, JSONRPCMessageSchema as t };
//# sourceMappingURL=src-C1G0D-5v.mjs.map